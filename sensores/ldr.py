...
Sensor1 = MoreGpio_ESP32(bus_number=1, address=0x08)
Sensor2 = MoreGpio_ESP32(bus_number=1, address=0x08)
# Define el pin GPIO donde está conectado el sensor (ajústalo según tu configuración)
pin_sensorLDR1 = Sensor1.get_adc_pin("ADCPin36")
pin_sensorLDR2 = Sensor2.get_adc_pin("ADCPin39")
...
def sensorLDR():
    ...
    try:
        while True:
            ...
            #LDR1
            sensor1_value, idPin_Return1= Sensor1.readSensor(Sensor1.command_adc, pin_sensorLDR1, cont)
            ...
            #LDR 2
            sensor2_value, idPin_Return2 = Sensor2.readSensor(Sensor2.command_adc, pin_sensorLDR2, cont)
